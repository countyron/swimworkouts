# Metric Swim Workout Library v4.1

V4.1 fixes the V4 startup crash caused by missing DOM elements and adds more defensive event binding.

## Required Supabase step
Run `supabase_schema_v4.sql` in Supabase SQL Editor before using `Sync to cloud` for the v4 database.

## Upgrade path
1. Upload all v4.1 files to the GitHub repository root.
